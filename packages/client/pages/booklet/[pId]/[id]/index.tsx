          ...
          <>
            <div className={cls(style.breadcrump)}>
              <Breadcrumb>
                ...
                <Breadcrumb.Item>
                  <Link as={`/booklet/${pId}`} href="/booklet/[pId]">
                ...
                <article>
                  ...
                  <div className={style.navigation}>
                    {prev && (
                      ...
                      >
                        <Link href={`/booklet/[pId]/[id]`} as={`/booklet/${pId}/${prev.id}`}>
                    ...
                    {next && (
                      ...
                      >
                        <Link href={`/booklet/[pId]/[id]`} as={`/booklet/${pId}/${next.id}`}>
                  ...
                  {chapters.map((chapter) => {
                    return (
                      <li key={chapter.id} id={`js-toc-item-wrapper-${chapter.id}`}>
                        <Link as={`/booklet/${pId}/${chapter.id}`} href={`/booklet/[pId]/[id]`}>
